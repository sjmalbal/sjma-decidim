...
ActiveRecord::Schema[7.0].define(version: 2026_06_03_020000) do
  ...
  create_table "decidim_users", id: :serial, force: :cascade do |t|
    ...
    t.string "sjma_dni_digest"
    t.string "sjma_dni_last4"
    t.string "sjma_member_number"
    t.boolean "sjma_member_active", default: false, null: false
    t.boolean "sjma_must_change_password", default: false, null: false
    t.datetime "sjma_synced_from_supabase_at"
    t.index ["confirmation_token"], name: "index_decidim_users_on_confirmation_token", unique: true
    t.index ["decidim_organization_id", "sjma_dni_digest"], name: "index_decidim_users_on_org_and_sjma_dni_digest", unique: true, where: "((sjma_dni_digest IS NOT NULL) AND (deleted_at IS NULL))"
    ...
    t.index ["sjma_member_active"], name: "index_decidim_users_on_sjma_member_active"
    t.index ["sjma_member_number"], name: "index_decidim_users_on_sjma_member_number"
